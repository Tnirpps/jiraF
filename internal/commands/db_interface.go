...
type DBManager interface {
	...
	SaveDraftTask(ctx context.Context, sessionID int, title, description, dueISO string, priority int, taskType string, labels, missingDetails []string, selectedLinks []tasklinks.TaskLink, assigneeNote string) error
